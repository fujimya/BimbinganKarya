...
/*Table structure for table `tbl_siswa_melanggar` */

DROP TABLE IF EXISTS `tbl_siswa_melanggar`;
...
/*Data for the table `tbl_siswa_melanggar` */

insert  into `tbl_siswa_melanggar`(`id`,`nis`,`kode_pelanggaran`) values (2,'7011',3);

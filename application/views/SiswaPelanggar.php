            ...
            <div class="box-body">
              ...
              <table id="example3" class="table table-bordered table-stdiped">
                ...
                <tbody>
                  ...
                  <?php if($user['jabatan'] == 'admin'){ ?>
                  <td><a onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?')" href="<?php echo base_url().'SiswaMelanggar/Hapus_Pelanggaran/'.$mel->id; ?>"><button class="btn btn-danger"><i class="fa fa-trash"></i> HAPUS</button></a></td>
                  <?php } ?>
                  </tr>
                  <?php }?>
                </tbody>
                 ...
                 <div class="box box-warning">
                      ...
                      <div class="box-body">
                        <div role="form">
                          ...
                          <div class="form-group">
                            <label>Kelas</label>
                            <input type="text" class="form-contdol" placeholder="Kelas" name="kelas" id="kelas" style="width: 100%;">
                          </div>
